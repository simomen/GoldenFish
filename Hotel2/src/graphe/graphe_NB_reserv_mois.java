...
public class graphe_NB_reserv_mois extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultSet rs = InfoReservationDAO.getInstance().graphe_NB_reserv_mois();
		 ...
		 JFreeChart barChart = ChartFactory.createBarChart("Graphe Presente le Nombre des chambre réserver par mois de l'année courant", "","NB Clients", dataset, PlotOrientation.VERTICAL, true, true, false); 
