		...
		<div id="content">
			...
			<div class="container">
				...
				<div class="content">
					<div class="indent3">
						<h2>Menu Du Jour</h2>
						<img class="img-indent png alt" alt="" src="images/r4.png" />
						<div class="extra-wrap">
							<h5>Cocktail!</h5>
							<ul class="list2">
								<li>Nice et savoureux!!</li>
								<li>Made from Morocco!</li>
								<li>Cocktail de thés froids!</li>
								<li>de votre choix!!!</li>
								<li>Pour decouvrir notre gamme de Cocktail de thes froids c est ici !</li>
							</ul>
							<div class="aligncenter">
								<strong class="txt2">AS LOW AS $7!</strong>
							</div>
						</div>
					</div>
				</div>
