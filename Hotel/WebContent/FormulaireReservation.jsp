...
<script type="text/javascript">
	function verif() {
		...
		|| document.form.email.value == "" || document.form.emailto.value == ""
		...
		<div id="content">
			...
			<div class="indent" align="Center">
				...
				<fieldset title="Information Sejour">
					...
					<form action="Reserver.jsp" name="formulaire" method="post">
						<table>
							<tr>
								...
								<td valign="top">Informations :<br> hotel&nbsp;&nbsp;
									...
									un prix exclusive :&nbsp;&nbsp;<font color="red"> <%=rs.getPrixtotal()%>DH
								</font>
				...
				<form action="https://www.sandbox.paypal.com/cgi-bin/webscr"
					...
					<fieldset>
						...
						<br> <input type='hidden' value="<%=rs.getPrixtotal() / 2%>"
							name="amount" /> <input name="currency_code" type="hidden"
							value="EUR" /> <input name="shipping" type="hidden" value="0.00" />
						<input name="tax" type="hidden" value="0.00" /> <input
							name="return" type="hidden"
							value="http://votredomaine/paiementValide.php" /> <input
							name="cancel_return" type="hidden"
							value="http://votredomaine/paiementAnnule.php" /> <input
							name="notify_url" type="hidden"
							value="http://votredomaine/validationPaiement.php" /> <input
							name="cmd" type="hidden" value="_xclick" /> <input
							name="business" type="hidden"
							value="lets_g_1340990817_biz@hotmail.com" /> <input
							name="item_name" type="hidden" value="Chambre" /> <input
							name="no_note" type="hidden" value="1" /> <input name="lc"
							type="hidden" value="FR" /> <input name="bn" type="hidden"
							value="PP-BuyNowBF" /> <input name="custom" type="hidden"
							value="ID_ACHETEUR" /> <input
							alt="Effectuez vos paiements via PayPal : une solution rapide, gratuite et sécurisée"
							name="submit" src="images/reserver.jpg" type="image" /><img
