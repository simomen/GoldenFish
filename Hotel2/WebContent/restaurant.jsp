...
<!-- box begin -->
				<div class="box maxheight">
					<div class="inner">
						<h3>Menu</h3>
						<ul class="list3">
					 		<li><a href="restaurant.jsp">Promotions</a></li>
							<li><a href="r2.jsp">Dejeuner</a></li>
							<li><a href="r3.jsp">Diner</a></li>
							<li><a href="r4.jsp">Boisson</a></li>
						
							
						</ul>
						<div class="button"><span><span></span></span></div>
					</div>
				</div>
<!-- box end -->
			</div>
